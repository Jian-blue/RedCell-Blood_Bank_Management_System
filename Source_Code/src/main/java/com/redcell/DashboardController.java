...
public class DashboardController {
    ...
    private String loggedInUsername = "Guest"; // Default to Guest

    public void setLoggedIn(boolean loggedIn) {
        isLoggedIn = loggedIn;
        updateUIForLoggedInState(loggedIn);
    }
    ...
    private void handleContactAction() {
        ...
        contactDialog.setContentText("We're here to help! Contact us through any of these channels:\n\n" +
                "Email: redcell2025@mail.gov.bd\n" +
                "Phone: +880 16123-45672\n" +
                "Address: 123 AB4, DSC\n" +
                "           Birulia, Savar-1216\n" +
                "           City, Dhaka\n\n" +
    ...
    private void updateUIForLoggedInState(boolean loggedIn) {
        if (loggedIn) {
            userNameText.setText(loggedInUsername); // Use the stored username
        } else {
